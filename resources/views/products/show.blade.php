                            ...
                            <div class="card">
                                <div class="card-body">
									...
									<tr>
                                        ...
                                        <td>{{ $product->sub_category ? $product->sub_category->created_at : '' }}</td>
                                    </tr>
									<tr>
                                        <td class="fw-bold">{{ __('Product Unit') }}</td>
                                        <td>{{ $product->product_unit ? $product->product_unit->id : '' }}</td>
                                    </tr>
									<tr>
									...
									<tr>
                                            ...
                                            <td>{{ $product->harga_subdis }}</td>
                                        </tr>
									<tr>
                                            <td class="fw-bold">{{ __('Harga Distributor') }}</td>
                                            <td>{{ $product->harga_distributor }}</td>
                                        </tr>
									<tr>
