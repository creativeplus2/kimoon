            ...
            <div class="row">
                <div class="col-md-4 text-center">
                    @if ($bank->logo_bank == null)
                        <img src="https://via.placeholder.com/350?text=No+Image+Avaiable" alt="Logo Bank" class="rounded mb-2 mt-2" alt="Logo Bank">
                    @else
                        <img style="width: 100%" src="{{ asset('storage/uploads/logo_banks/' . $bank->logo_bank) }}" alt="Logo Bank" class="rounded mb-2 mt-2">
                    @endif
                </div>
