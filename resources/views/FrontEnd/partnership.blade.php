                                ...
                                <ul class="list-unstyled contact-one__info">
                                    <li class="contact-one__info__item">
                                        ...
                                        <div class="contact-one__info__content">
                                            ...
                                            <h4 class="contact-one__info__title"><a href="#">{{ $setting->no_telpon }}</a></h4><!-- /.contact-one__info__title -->
                                    ...
                                    <li class="contact-one__info__item">
                                        ...
                                        <div class="contact-one__info__content">
                                            ...
                                            <!-- /.contact-one__info__text -->
                                            <h4 class="contact-one__info__title"><a href="mailto:{{ $setting->email }}">{{ $setting->email }}</a></h4>
                                    ...
                                    <li class="contact-one__info__item">
                                        ...
                                        <div class="contact-one__info__content">
                                            ...
                                            <h4 class="contact-one__info__title"><a href="#">{{ $setting->alamat }}</a></h4><!-- /.contact-one__info__title -->
                                        </div><!-- /.contact-one__info__content -->
                                    </li>
                                </ul><!-- /.list-unstyled -->
