            ...
            <div class="col-lg-6 col-xl-6 wow fadeInLeft" data-wow-delay="200ms">
                <div class="product-details__img">
                    <img id="image-preview-thumb"
                        src="{{ count($product->images) >= 1 ? '/storage/produk/' . $product->images[0]->photo : '/images/no-photo.jpg' }}"
                        alt="{{ $product->nama_produk }}">
                    <div class="product-details__img-search">
                        <a id="image-preview-thumb-popup" class="img-popup"
                            href="{{ count($product->images) >= 1 ? '/storage/produk/' . $product->images[0]->photo : '/images/no-photo.jpg' }}"><span
